...
const EVENTS = [
  ...
  {
    id: "milonga-sentimental",
    recurrence: "dated",
    dates: ["2026-07-25", "2026-10-24"],
    name: "Milonga Sentimental",
    host: "Tango Culture",
    venue: "Unley Community Centre",
    address: "18 Arthur St, Unley SA 5061",
    time: "8:00 PM – 11:00 PM",
    cost: "Check event page for pricing",
    styles: ["Tango"],
    description: "Tango Culture Adelaide's monthly milonga, held on the 4th Saturday of the month at Unley Community Centre.",
    note: "August and November editions are special (see Tango Culture Birthday Celebration and Christmas Party listings) — confirm dates/link via Tango Culture.",
  },
  {
    id: "milonga-de-los-amigos",
    recurrence: "dated",
    dates: ["2026-09-05", "2026-10-03", "2026-11-07"],
    name: "Milonga de los Amigos",
    host: "Tango Culture",
    venue: "Check with Tango Culture for venue",
    time: "8:00 PM – 11:00 PM",
    cost: "Check event page for pricing",
    styles: ["Tango"],
    description: "Tango Culture invites you to a joyful, friendly milonga where embraces are warm, the music is golden, and everyone feels welcome.",
    note: "Venue wasn't listed on the event page — confirm via Tango Culture before heading down.",
  },
  {
    id: "milonga-sentimental-birthday-aug22",
    recurrence: "dated",
    dates: ["2026-08-22"],
    name: "Milonga Sentimental — Tango Culture Birthday Celebration",
    host: "Tango Culture",
    venue: "Unley Community Centre",
    address: "18 Arthur St, Unley SA 5061",
    ...
    cost: "Check event page for pricing",
    styles: ["Tango"],
    description: "Tango Culture's 3rd Anniversary Celebration — Una Noche de Tango, Amistad y Emoción (A Night of Tango, Friendship & Emotion).",
  },
  {
    id: "milonga-sentimental-christmas-nov28",
    recurrence: "dated",
    dates: ["2026-11-28"],
    name: "Milonga Sentimental — Christmas Party",
    host: "Tango Culture",
    venue: "Unley Community Centre",
    address: "18 Arthur St, Unley SA 5061",
    time: "8:00 PM – 11:00 PM",
    cost: "Check event page for pricing",
    styles: ["Tango"],
    description: "The Christmas Party edition of Tango Culture's monthly Milonga Sentimental.",
  },
  {
    id: "samba-social-club-aug21",
    recurrence: "dated",
    dates: ["2026-08-21"],
    name: "Samba Social Club",
    host: "SA Samba",
    venue: "Check SA Samba's website for details",
    time: "Check SA Samba's website for details",
    cost: "Check SA Samba's website for details",
    styles: ["Samba"],
  ...
  // ------------------------------------------------------------- ONE-OFFS
  {
    ...
    recurrence: "dated",
    dates: ["2026-08-02"],
    name: "Live Band — Melenge Latino",
    host: "Melenge Latino",
    venue: "Cheese Factory",
    address: "Mount Barker",
    time: "3:30 PM – 5:00 PM",
    cost: "See ticket link for pricing",
    styles: ["Salsa"],
    description: "Live Latin band Melenge Latino performing at the Cheese Factory in Mount Barker.",
